...
public class Capteurs extends AppCompatActivity {
    ...
    DatabaseReference referenceEntrada1 = database.getReference("SALLE2").child("MOUVMENT");
    DatabaseReference referenceEntrada2 = database.getReference("SALLE2").child("lecture");

    DatabaseReference referenceEntrada3 = database.getReference("SALLE2").child("gaz");
    double m,k;
