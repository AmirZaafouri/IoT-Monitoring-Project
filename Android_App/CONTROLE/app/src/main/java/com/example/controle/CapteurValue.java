...
public class CapteurValue extends AppCompatActivity {
    TextView temp,hum,gaz;
    GraphView graph;
    ImageView imageView,imageView5,imageView3;
    FirebaseDatabase database= FirebaseDatabase.getInstance();

    DatabaseReference referenceEntrada1 = database.getReference("SALLE3").child("MOUVMENT");
    DatabaseReference referenceEntrada2 = database.getReference("SALLE3").child("lecture");

    DatabaseReference referenceEntrada3 = database.getReference("SALLE3").child("gaz");
    double m,k;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capteur_value);
